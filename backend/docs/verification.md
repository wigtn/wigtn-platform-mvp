...
| DB/RLS/integration tests           | 87 passed; 8 conditional tests skipped                                            |
| login-free demo E2E                | pass; two anonymous visitors isolated, live commands denied, AI polling completed |
...
- Anonymous visitors remain pending members, cannot call live member/admin commands, and can access only their private demo ledger through a fixed action allowlist.
...
2. Configure SMTP, allowed redirects, Storage limits, network restrictions, backups/PITR, alerting, secret manager, anonymous-user cleanup, and Turnstile/CAPTCHA.
